...
public class QuantumUploadDeviceResponseService {
    ...
    private final HttpDeviceToServerGateway httpDeviceToServerGateway;

    private final MessageChannel sendDataToBrandLink;
    public QuantumUploadDeviceResponseService(Logger logger, HttpDeviceToServerGateway httpDeviceToServerGateway, @Qualifier("hb-response-out-channel") MessageChannel sendDataToBrandLink) {
        this.logger = logger;
        this.httpDeviceToServerGateway = httpDeviceToServerGateway;
